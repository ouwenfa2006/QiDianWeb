 ...
 * 2017-02-18T01:23:51.171+08:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "WebService", 
                  wsdlLocation = "http://sdk.entinfo.cn:8060/webservice.asmx?WSDL",
...
public class WebService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://sdk.entinfo.cn:8060/webservice.asmx?WSDL");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WebService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://sdk.entinfo.cn:8060/webservice.asmx?WSDL");
        }
        WSDL_LOCATION = url;
    }
